...
def score_answer(question: str, answer: str) -> dict:
    ...
    resp = client.chat([{"role":"system","content":SYSTEM},{"role":"user","content":prompt}], temperature=0.0)
    try:
        return json.loads(resp)
    except Exception:
        return {"bloom_level":"understand","score":0.0,"confidence":0.0,"errors":["parse_error"],"skills":[]}
